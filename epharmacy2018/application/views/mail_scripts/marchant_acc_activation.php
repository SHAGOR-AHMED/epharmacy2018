...
<head>
    ...
    <title>Merchant Account Activation</title>
</head>
<body>
            ...
            <td align="center" valign="top" style="background-color:#53636e;" bgcolor="#53636e;">
                ...
                <table width="583" border="0" cellspacing="0" cellpadding="0">
                    <tr style="height: 100px;">
                        <td align="left" valign="top" bgcolor="#FFFFFF" style="background-color:#3d90bd;">
                                ...
                                <tr>
                                    ...
                                    <td align="left" valign="top">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                <td align="left" valign="top"
                                                    style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#525252; text-align: center">

                                                    <div style="color:#3482ad; font-size:19px;">
                                                       <a href="<?php echo $link; ?>">  Do Active Your Merchant Account !</a>
                                                    </div>
                                                    <br>
                                                    <h3>Thank you for join with us ... </h3><br>
