...
<h2 class="display-inline-inline sku-page-cat">Body Products</h2>
<div class="row">
	</div>
...
?>
	...
	<div class="sku-name"><?php print $value->prod_name;?></div></a><div class="sku-pack"></div><div class="sku-price"><div class="sku-offer display-inline"><?php print $value->prod_price;?>.Tk</div><div class="sku-actual display-inline"></div>
	</div>
	</div>
	<a href="<?php print base_url('add_cart'.'/'.$value->prod_id);?>" data-id="340509" data-avail="yes" data-su="1" class="value submit-btn js-avail button-text btn btn-checkout btn-add-sku-to-cart category-sku-add-to-cart btn btn-primary crtDiaOp"><div class="add-to-cart-text">Add to cart</div><div class="add-to-cart-arrow"><i class="fa fa-long-arrow-right fa-2x"></i></div></a>
	</div>
	</div>
<?php }?>
<!--end single product-->
	...
	<!--	<div class="row text-center"><div class="col-md-12"><a data-number="1" data-size="12" data-url="/api/v3/getMoreOTC/19?" href="skin-care-19b4df.html?pageNumber=1&amp;pageSize=12" class="pgntnCntnrBar btn btn-primary text-small button-text">load more</a><div class="loading-icon v2 hide"></div></div>
		</div>-->
		</div>
