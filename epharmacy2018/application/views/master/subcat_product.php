...
<div class="col-md-10 col-sm-9 sku-list">
	...
	<h2 class="display-inline-inline sku-page-cat">
	    <?php
	       if($this->session->userdata('c_name'))
	       print $this->session->userdata('c_name')." (".count($subcat_product).") ";
	...
	<div class="row">
	<?php 
		foreach ($subcat_product as $value) {
	?>
	...
	<div class="sku-name"><?php print $value->prod_name;?></div>
	</a>
	<div class="sku-pack">code: <?php print $value->prod_code;?></div><div class="sku-price"><div class="sku-offer display-inline"><?php print $value->prod_price;?>.Tk</div><div class="sku-actual display-inline"></div>
	</div>
	</div>
