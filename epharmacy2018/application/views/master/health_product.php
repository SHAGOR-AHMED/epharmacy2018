...
<div class="row">
<div class="col-xs-12"><h1 class="display-inline-inline sku-page-cat">Popular Health Product Categories</h1></div></div>

<div class="row">
<?php
//$result=$this->db->select('*')->from('subcategory')->where('subcat_catid',54)->order_by('subcat_id','DESC')->get()->result();
$result=$this->db->select('*')->from('category')->where('type',1)->order_by('cat_id','DESC')->get()->result();
