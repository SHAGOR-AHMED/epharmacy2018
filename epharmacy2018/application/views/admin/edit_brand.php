	...
	<div class="inner_content">
        ...
        <div class="block">
            <div class="navbar navbar-inner block-header">
                <div class="muted pull-left">Update Brand</div>
            </div>
              <?php
            ...
            <div class="block-content collapse in">
                <div class="span12">
                    <form action="<?php echo base_url('edit_brand_save');?>" enctype="multipart/form-data" method="post">
                        <div class="control-group">
                            <input type="hidden" name="id" value="<?php print $result->id;?>">
                          <label class="control-label" for="userfile">Name</label>
                          <div class="controls">
                            <input type="text" name="name" value="<?php print $result->brand_name;?>" id="company" class="form-control" required>
                          </div>
                        </div>
                        <br>
