...
<html lang="zxx">
<head>
<title>ePharmacy admin panel</title>
<!-- custom-theme -->
...
<div class="wthree_agile_admin_info">
		  ...
		  <div class="w3_agileits_top_nav">
			<ul id="gn-menu" class="gn-menu-main">
				...
				<!-- //nav_agile_w3l -->
                <li class="second logo admin"><h1><a href=""><i class="fa fa-graduation-cap" aria-hidden="true"></i>ePharmacy</a></h1></li>
...
<div class="copyrights">
	 <p>© 2017 ePharmacy. All Rights Reserved | Design by  <a href="#" target="_blank">Roni Sharma</a> </p>
</div>	
