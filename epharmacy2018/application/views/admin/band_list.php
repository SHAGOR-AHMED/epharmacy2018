		...
		<div class="inner_content_w3_agile_info">
			...
			<div class="agile_top_w3_grids">
				 <div class="navbar navbar-inner block-header">
                    <div class="muted pull-left">All Brand &nbsp;
                        <a href="<?php print base_url('add_brand');?>">
                            ...
                            <tbody>
                            	...
                            	?>
                                    <tr>
                                        ...
                                        <td class="center"><?php print $value->brand_name;?></td>

                                        <td class="center"><a href="<?php print base_url('edit_brand'.'/'.$value->id);?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Edit</a></td>

                                       <!-- <td class="center"><a href="<?php //print base_url('delete_brand'.'/'.$value->id);?>"><i class="fa fa-trash" aria-hidden="true"></i>Delete</a></td>-->
                                    </tr>
                                <?php }?>
                            </tbody>
                        </table>
