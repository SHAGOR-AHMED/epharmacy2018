                            ...
                            <tbody>
                            	...
                            	?>
                                    <tr>
                                        ...
                                        <td class="center"><?php print $customer->date;?></td>
                                        <td class="center">
                                        <?php 
                                            if($customer->active==1){
                                        ?>
                                        <a href="<?php print base_url('active2/'.$customer->customer_id);?>"> <button class="btn btn-primary">Active</button></a>
                                        <?php } else{ ?>
                                        <a href="<?php print base_url('inactive2/'.$customer->customer_id);?>"><button class="btn btn-danger">Inactive</button></a>
                                        <?php }?>
                                        </td>                                       
                                    </tr>
                                <?php }?>
